...
const char* ssid = "OrbitGKU"; 
const char* password = "AELab123";
unsigned long myChannelNumber1 = 2061743;
unsigned long myChannelNumber2 = 2061748;
const char * WriteAPIKey1 = "5UHARAYM6W1NQPJJ";
const char * WriteAPIKey2 = "MECGXZ1CVY8EME11";
int x1,x2;
 WiFiClient  client;
